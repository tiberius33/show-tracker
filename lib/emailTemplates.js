...
export function bulkShowTagNotification({ taggerName, showsList, uid }) {
...
export function engagementNotificationEmail({ fromName, message, artist, venue, date, uid }) {
...
export function venueVerificationSubmittedEmail({ venueName, uid }) {
...
export function venueVerificationApprovedEmail({ venueName, venueKey, uid }) {
...
export function venueVerificationRejectedEmail({ venueName, rejectionReason, uid }) {
...
export function yearInReviewReadyEmail({ year, userId, uid }) {
