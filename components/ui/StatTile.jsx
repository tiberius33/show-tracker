...
export default function StatTile({ value, unit, label, delta, trend = 'up', tone = 'default', className = '' }) {
  const TrendIcon = TREND[trend]?.icon;

  return (
    <div className={`bg-surface border border-subtle rounded-2xl p-5 md:p-6 ${className}`}>
