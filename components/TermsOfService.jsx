      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        <div className="bg-highlight backdrop-blur-xl border border-subtle rounded-3xl p-8 sm:p-12">
          ...
          <div className="prose-legal space-y-8 text-secondary leading-relaxed">
            ...
            <section>
              <h2 className="text-xl font-semibold text-primary mb-4">4. Acceptable Use</h2>
            ...
            <section>
              <h2 className="text-xl font-semibold text-primary mb-4">5. Third-Party Services and Data</h2>
            ...
            <section>
              <h2 className="text-xl font-semibold text-primary mb-4">6. Intellectual Property</h2>
            ...
            <section>
              <h2 className="text-xl font-semibold text-primary mb-4">7. Disclaimer of Warranties</h2>
            ...
            <section>
              <h2 className="text-xl font-semibold text-primary mb-4">9. Indemnification</h2>
            ...
            <section>
              <h2 className="text-xl font-semibold text-primary mb-4">10. DMCA and Copyright</h2>
            ...
            <section>
              <h2 className="text-xl font-semibold text-primary mb-4">11. Termination</h2>
            ...
            <section>
              <h2 className="text-xl font-semibold text-primary mb-4">12. Governing Law</h2>
            ...
            <section>
              <h2 className="text-xl font-semibold text-primary mb-4">13. Changes to These Terms</h2>
            ...
            <section>
              <h2 className="text-xl font-semibold text-primary mb-4">14. Severability</h2>
